...
// Comets are the only body kind still spawned/despawned from a shared pool
// (see world/solarSystem.js's header comment for why the 9 fixed orbit
// bodies + sun no longer need one at all).
