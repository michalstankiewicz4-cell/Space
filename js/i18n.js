...
const STRINGS = {
  en: {
    ...
    wiki: {
      title: "WIKI",
      tabs: { systems: "Systems", bodies: "Planets", elements: "Elements", minerals: "Minerals", ores: "Ores", resources: "Refined", materials: "Materials", buildings: "Buildings", ships: "Ships", tech: "Technologies", programming: "Programming", races: "Races", lifeforms: "Life forms", artifacts: "Artifacts" },
  ...
  pl: {
    ...
    wiki: {
      title: "WIKI",
      tabs: { systems: "Układy", bodies: "Planety", elements: "Pierwiastki", minerals: "Minerały", ores: "Rudy", resources: "Surowce", materials: "Materiały", buildings: "Budynki", ships: "Statki", tech: "Technologie", programming: "Programowanie", races: "Rasy", lifeforms: "Formy życia", artifacts: "Artefakty" },
      hint: { inspect: "Jeszcze nieodkryte — przyjrzyj mu się z bliska na orbicie (zaznacz je albo najedź na nie kursorem).", research: "Jeszcze nieodkryte — kup pierwsze ulepszenie w Badaniach.", script: "Jeszcze nieodkryte — uruchom skrypt drona po raz pierwszy.", use: "Jeszcze nieodkryte — użyj tego w programie drona i uruchom go.", blocks: "Jeszcze nieodkryte — uruchom program drona zbudowany z klocków.", files: "Jeszcze nieodkryte — utwórz drugi plik w edytorze klocków.", future: "Jeszcze nieodkryte — ta część wszechświata otworzy się w przyszłej aktualizacji.", life: "Jeszcze nieodkryte — coś tam wciąż żyje. Pojawi się w przyszłej aktualizacji.", relic: "Jeszcze nieodkryte — ludzi już nie ma, ale nie wszystko, co zrobili, zniknęło. Pojawi się w przyszłej aktualizacji." },
