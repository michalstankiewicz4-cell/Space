...
const STRINGS = {
  en: {
    ...
    wiki: {
      title: "WIKI",
      tabs: { systems: "Systems", bodies: "Planets", elements: "Elements", minerals: "Minerals", ores: "Ores", resources: "Refined", materials: "Materials", buildings: "Buildings", ships: "Ships", tech: "Technologies", programming: "Programming", races: "Races" },
      hint: { inspect: "Not discovered yet — take a closer look at it in orbit (select it or hover over it).", research: "Not discovered yet — buy its first upgrade in Research.", script: "Not discovered yet — run your drone's script for the first time.", use: "Not discovered yet — use this in a drone program and run it.", blocks: "Not discovered yet — run a drone program built from blocks.", files: "Not discovered yet — create a second file in the block editor.", future: "Not discovered yet — this part of the universe opens up in a future update." },
  ...
  pl: {
    ...
    wiki: {
      title: "WIKI",
      tabs: { systems: "Układy", bodies: "Planety", elements: "Pierwiastki", minerals: "Minerały", ores: "Rudy", resources: "Surowce", materials: "Materiały", buildings: "Budynki", ships: "Statki", tech: "Technologie", programming: "Programowanie", races: "Rasy" },
      hint: { inspect: "Jeszcze nieodkryte — przyjrzyj mu się z bliska na orbicie (zaznacz je albo najedź na nie kursorem).", research: "Jeszcze nieodkryte — kup pierwsze ulepszenie w Badaniach.", script: "Jeszcze nieodkryte — uruchom skrypt drona po raz pierwszy.", use: "Jeszcze nieodkryte — użyj tego w programie drona i uruchom go.", blocks: "Jeszcze nieodkryte — uruchom program drona zbudowany z klocków.", files: "Jeszcze nieodkryte — utwórz drugi plik w edytorze klocków.", future: "Jeszcze nieodkryte — ta część wszechświata otworzy się w przyszłej aktualizacji." },
